...
-- Filtro por ligas específicas (apenas jogos do dia em BRT já aplicado)
...
targets as (
  ...
  where f.league_id in (
    648, 651, 654,  -- Brasil: Série A, Série B, Copa do Brasil
    636,            -- Argentina: Primera División
    1122, 1116,     -- CONMEBOL: Libertadores, Sudamericana
    2, 5,           -- UEFA: Champions, Europa League
    8, 9,           -- Inglaterra: Premier, Championship
    564,            -- Espanha: LaLiga
    462,            -- Portugal: Liga Portugal
    301,            -- França: Ligue 1
    82,             -- Alemanha: Bundesliga
    743,            -- México: Liga MX
    779             -- EUA: MLS
  )
),
...
comment on view analytics.v_fixtures_upcoming is 'Jogos de hoje (BRT) apenas das ligas principais informadas; horário BRT, nomes de times, médias e DIFFs como totais.';
