-- Update view: analytics.v_fixtures_upcoming (DIFF como exibição "IT1 - IT2")
...
select
  ...
  -- DIFF como exibição de totais "IT1 - IT2"
...
comment on view analytics.v_fixtures_upcoming is 'Jogos da semana (UTC) com médias de cartões; DIFF/DIFF 1h exibem "IT1 - IT2" (totais), sem subtração. Times por liga/temporada; árbitro por últimos 50 (>=10) com fallback por liga/temporada.';
