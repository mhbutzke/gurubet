-- Update view: analytics.v_fixtures_upcoming (add DIFFs and J)
...
comment on view analytics.v_fixtures_upcoming is 'Jogos da semana (UTC) com médias de cartões (amarelo=1, vermelho direto=2, segundo amarelo=2). Times por liga/temporada; árbitro por últimos 50 (>=10) com fallback liga/temporada. Inclui DIFFs e J.';
