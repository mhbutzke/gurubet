-- Fix BRT conversion in analytics.v_fixtures_upcoming
-- - Filtra "hoje" com base em BRT correto partindo de UTC armazenado
-- - starting_at_brt calculado a partir de UTC -> BRT
...
comment on view analytics.v_fixtures_upcoming is 'Jogos de hoje (BRT) com BRT correto a partir de UTC; ligas principais; nomes, médias e DIFFs (totais).';
