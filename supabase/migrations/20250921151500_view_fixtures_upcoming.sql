-- View: analytics.v_fixtures_upcoming
-- Jogos da semana (seg->dom) a partir de agora, com métricas de cartões por time e árbitro
...
-- Histórico de partidas por time na mesma liga/temporada dos alvos
...
team_avgs as (
  -- Média por time dentro da (liga, temporada) (todas as partidas históricas)
...
comment on view analytics.v_fixtures_upcoming is 'Jogos restantes da semana (UTC) com métricas de cartões por time (tomados/provocados) e árbitro; regras: amarelo=1, vermelho direto=2, segundo amarelo=2; 1h = minutos <=45.';
