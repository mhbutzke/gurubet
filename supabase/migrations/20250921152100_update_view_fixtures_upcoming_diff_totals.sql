...
-- Ajuste DIFF/DIFF 1h para exibir totais (não médias) dos jogos usados nas médias
...
comment on view analytics.v_fixtures_upcoming is 'Jogos de hoje (BRT) com horário formatado, nomes de times, médias e DIFF/DIFF 1h como totais dos jogos usados.';
